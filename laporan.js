  ...
  try {
    ...
    return new Promise(resolve => {
      ...
      req.onsuccess = () => {
        ...
        // Store menyimpan flat object, bukan {data: ...}
        const laporanData = laporan.data || laporan;
        let grossMargin = 0, pengeluaranKurir = 0;
        Object.values(laporanData).forEach(kurir => {
          if (typeof kurir !== "object" || !kurir?.distribusi) return;
        ...
        const p = laporanData?.pengeluaranDistribusi;
  ...
  try {
    ...
    return new Promise(resolve => {
      ...
      req.onsuccess = () => {
        ...
        Object.values(laporanData).forEach(item => {
          if (typeof item !== "object") return;
          pembayaranKurir += Number(item?.pembayaran?.nota?.bayar) || 0;
        });
        const produksi = laporanData?.pengeluaranProduksi || {};
